    ...
    return render_prompt(
        PromptDocument(
            ...
            requirements=[
                ...
                "如果 Research Summary 中带有 research_review 且未通过，design.md 不能写成确定可执行方案；应 degraded 或 needs_human。",
                "如果 Program Quality Report 中有 research_gate 且 passed=false，不能 pass；应 degrade_design 或 needs_human，并说明 research 未通过。",
                "Design 主落点必须来自 Research Agent 的 candidate_files 或 supported claims；rejected_candidates 只能作为边界，不能作为改造落点。",
