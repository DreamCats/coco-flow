    ...
    return render_prompt(
        PromptDocument(
            ...
            requirements=[
                ...
                "Design Skills Local Fallback 只是 local fallback 摘要，不得替代完整 skill 文件，不得扩写 refined PRD。",
            ...
            sections=[
                ...
                PromptSection("Design Skills Local Fallback", design_skills_fallback_markdown.strip() or "- 当前没有 Design skills fallback。"),
