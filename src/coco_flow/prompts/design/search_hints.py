    ...
    return render_prompt(
        PromptDocument(
            ...
            requirements=[
                ...
                "Design Skills Brief 只能用于补充搜索线索、常见模块名和 SOP 检查点，不得扩写 refined PRD。",
            ...
            sections=[
                ...
                PromptSection("Design Skills Brief", design_skills_brief_markdown.strip() or "- 当前没有 Design skills brief。"),
