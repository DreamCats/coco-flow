...
gateway_app = typer.Typer(help="Manage the local coco-flow HTTP gateway.")
knowledge_app = typer.Typer(help="Manage knowledge documents.")
remote_app = typer.Typer(help="Connect to remote development machines over SSH.")
...
from .commands import gateway as _gateway  # noqa: E402,F401
from .commands import knowledge as _knowledge  # noqa: E402,F401
from .commands import remote as _remote  # noqa: E402,F401
