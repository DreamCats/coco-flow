...
def plan_task_local(task_dir: Path, task_meta: dict[str, object], on_log: LogHandler) -> PlanEngineResult:
    ...
    return PlanEngineResult(status=STATUS_PLANNED, design_markdown=design, plan_markdown=plan)
